...
const EMPTY_FORM = {
  ...
  judgeObservations: "",
  sentenceOrRelief: "",
  evidenceAcceptedByCourt: "",
  evidenceRejectedByCourt: "",
  finalVerdictDate: "",
  appealFiledAfterJudgment: "",
...
const STEPS = [
  ...
  { id: 8, label: "Judgment", icon: Gavel },
      ...
      >
        <div className="flex items-center justify-between px-4 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-sm">Decision Support</span>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 border-b border-[#e8ddd2] bg-[#f5ede0]/90 backdrop-blur-md flex items-center px-6 gap-4 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-sm">Decision Support Engine</h1>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <p className="max-w-2xl mx-auto text-[#7a6355] leading-7">
                    Advanced legal intelligence system that analyzes case facts, evidence,
                    witnesses, and procedural history to forecast outcomes and compare
                    AI-generated legal reasoning with actual court judgments.
                  </p>
                </div>
...
2022 - Case filed`}
                  ...
                  {step === 8 && (
                    <div className="space-y-6">
                      <SectionTitle
                        title="Actual Court Judgment"
                        subtitle="Provide the real court decision for AI comparison"
                      />

                      <div>
                        <Label>Actual Court Decision</Label>

                        <Select
                          value={form.actualCourtDecision}
                          onChange={(e) =>
                            setForm((prev) => ({
                              ...prev,
                              actualCourtDecision: e.target.value,
                            }))
                          }
                        >
                          ...
                          <option>Petition Allowed</option>
                          <option>Petition Dismissed</option>
                          <option>Partially Allowed</option>
                          <option>Bail Granted</option>
                          <option>Bail Rejected</option>
                          <option>Appeal Allowed</option>
                          <option>Appeal Dismissed</option>
                      ...
                      <div>
                        ...
                        <TextArea
                          rows={6}
                          value={form.judgeReasoning}
                          onChange={(e) =>
                            setForm((prev) => ({
                              ...prev,
                              judgeReasoning: e.target.value,
                            }))
                          }
                          placeholder="Enter detailed judicial reasoning from the judgment"
                        />
                      </div>

                      <div>
                        <Label>Important Court Observations</Label>
                        ...
                        <TextArea
                          ...
                          onChange={(e) =>
                            setForm((prev) => ({
                              ...prev,
                              judgeObservations: e.target.value,
                            }))
                          }
                          placeholder="Key observations made by the judge"
                        />
                      </div>

                      <div>
                        <Label>Sentence / Relief Granted</Label>

                        <TextArea
                          rows={4}
                          value={form.sentenceOrRelief}
                          onChange={(e) =>
                            setForm((prev) => ({
                              ...prev,
                              sentenceOrRelief: e.target.value,
                            }))
                          }
                          placeholder="Punishment, compensation, injunction, custody etc"
                        />
                      </div>

                      <div>
                        <Label>Evidence Accepted by Court</Label>

                        <TextArea
                          rows={4}
                          value={form.evidenceAcceptedByCourt}
                          onChange={(e) =>
                            setForm((prev) => ({
                              ...prev,
                              evidenceAcceptedByCourt: e.target.value,
                            }))
                          }
                          placeholder="What evidence did the court rely upon?"
                        />
                      </div>

                      <div>
                        <Label>Evidence Rejected by Court</Label>

                        <TextArea
                          rows={4}
                          value={form.evidenceRejectedByCourt}
                          onChange={(e) =>
                            setForm((prev) => ({
                              ...prev,
                              evidenceRejectedByCourt: e.target.value,
                            }))
                          }
                          placeholder="What evidence did the court reject?"
                        />
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                          <Label>Final Verdict Date</Label>

                          <Input
                            type="date"
                            value={form.finalVerdictDate}
                            onChange={(e) =>
                              setForm((prev) => ({
                                ...prev,
                                finalVerdictDate: e.target.value,
                              }))
                            }
                          />
                        </div>
                        ...
                        <div>
                          <Label>Appeal Filed After Judgment?</Label>

                          <Select
                            value={form.appealFiledAfterJudgment}
                            onChange={(e) =>
                              setForm((prev) => ({
                                ...prev,
                                appealFiledAfterJudgment: e.target.value,
                              }))
                            }
                          >
                            <option value="">Select</option>
            ...
            {showResult && (
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-between">
                  ...
                  <div className="flex-1">
                    <p className="text-[#c4965a] text-xs tracking-[0.2em] font-bold mb-3">
                      AI VS COURT COMPARISON
                    </p>

                    <h2 className="text-3xl font-extrabold leading-tight">
                      Judicial Decision Support Analysis
                    </h2>

                    <p className="text-[#d8c7b5] mt-4 leading-7">
                      AI-generated comparison between predicted legal reasoning and actual judicial outcome.
                    </p>
                  </div>

                  <div className="bg-white/10 rounded-2xl p-5 min-w-[220px]">
                    <p className="text-xs uppercase tracking-[0.2em] text-[#d8b98c]">
                      Alignment Score
                    </p>

                    <h2 className="text-5xl font-black mt-3">
                      {selected?.alignmentScore || 82}%
                    </h2>

                    <p className="text-sm text-[#d8c7b5] mt-2">
                      AI and judicial reasoning similarity
                    </p>
                  </div>
                </div>
              </GlassCard>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <GlassCard>
                  ...
                  <h2 className="text-2xl font-extrabold text-[#1f0d04] mb-4">
                    {selected?.aiPredictedDecision}
                  </h2>
              ...
              <GlassCard>
                <div className="flex items-center justify-between mb-5">
                  <div>
                    <p className="text-xs tracking-[0.2em] text-[#c4965a] font-bold mb-2">
                      DIFFERENCE ANALYSIS
                    </p>

                    <h3 className="text-2xl font-extrabold text-[#1f0d04]">
                      Why AI & Court Differed
                    </h3>
                  </div>

                  <div className="px-4 py-2 rounded-full bg-[#fff4e8] border border-[#f0d4ad] text-[#9b5b12] text-sm font-bold">
                    Judicial Intelligence
                  </div>
                </div>

                <p className="text-[#7a6355] leading-8 whitespace-pre-wrap">
                  {selected?.differenceAnalysis}
                </p>
              </GlassCard>


              {/* COURT CRITICAL FACTORS */}
              {selected?.courtCriticalFactors?.length > 0 && (
                <GlassCard>
                  <h3 className="text-xl font-extrabold mb-5 text-[#1f0d04]">
                    Key Factors Influencing the Judge
                  </h3>

                  <div className="space-y-4">
                    {selected.courtCriticalFactors.map((factor, i) => (
                      <div
                        key={i}
                        className="rounded-2xl border border-[#eadfce] bg-[#fffaf4] p-4"
                      >
                        <div className="flex items-start gap-4">
                          <div className="w-8 h-8 rounded-xl bg-[#2b1408] text-[#c4965a] flex items-center justify-center text-sm font-bold shrink-0">
                            {i + 1}
                          </div>

                          <p className="text-sm leading-7 text-[#2b1408]">
                            {factor}
                          </p>
                        </div>
                      </div>
              ...
              {/* APPEAL INTELLIGENCE */}
              <GlassCard className="border-[#d8c1a5] bg-gradient-to-br from-[#fffaf3] to-[#f7efe4]">

                <div className="flex items-center gap-4 mb-5">
                  <div className="w-12 h-12 rounded-2xl bg-[#2b1408] flex items-center justify-center">
                    <Scale className="text-[#c4965a]" size={22} />
                  </div>
                ...
                <p className="text-[#7a6355] leading-8 whitespace-pre-wrap">
                  {selected?.appealAnalysis}
                </p>
              </GlassCard>


              {/* STRATEGIC LEGAL INSIGHTS */}
              {selected?.strategicInsights?.length > 0 && (
                <GlassCard>
                  <h3 className="text-xl font-extrabold mb-5 text-[#1f0d04]">
                    Strategic Legal Insights
                  </h3>
                  ...
                  <div className="space-y-4">
                    {selected.strategicInsights.map((insight, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-4 rounded-2xl bg-[#f8f1e8] border border-[#eadfce] p-4"
                      >
                        <div className="w-8 h-8 rounded-xl bg-[#2b1408] text-[#c4965a] flex items-center justify-center text-sm font-bold shrink-0">
                          {i + 1}
                        </div>
